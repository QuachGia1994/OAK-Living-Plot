...
const styles = StyleSheet.create({
  ...
  metricFree: { minWidth: 40, color: colors.inkMuted, fontFamily: typography.display, fontSize: 28, lineHeight: 32, fontWeight: '700', fontVariant: ['tabular-nums'] },
  metricPlus: { minWidth: 54, color: colors.accentStrong, fontFamily: typography.display, fontSize: 28, lineHeight: 32, fontWeight: '700', textAlign: 'right', fontVariant: ['tabular-nums'] },
