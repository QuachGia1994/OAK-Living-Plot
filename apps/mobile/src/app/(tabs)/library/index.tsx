...
const styles = StyleSheet.create({
  ...
  filterCountSelected: { color: colors.violetStrong },
  ...
  sectionCount: { color: colors.violetStrong, fontFamily: typography.mono, fontSize: 10, fontWeight: '900', letterSpacing: 1.1 },
  ...
  thumbMark: { color: colors.violetStrong, fontFamily: typography.display, fontSize: 20, fontWeight: '700' },
