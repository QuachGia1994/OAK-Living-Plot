...
### Fixed
- Development Workers now bind an isolated `living_plot_events_dev` Analytics Engine dataset instead of relying on non-inherited production configuration, preserving fail-open generation telemetry without mixing environments or emitting a Wrangler warning.
