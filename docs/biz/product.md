...
## Product promise
Living Plot generates personalized 60–90 second drama episodes. Every episode ends with exactly three meaningful choices, and the selected choice must create a visible consequence in later episodes.
...
## Current exclusions
Generated video, voice cloning, Vector DB, multiplayer, creator marketplace, public Explore/trending catalog, ads in the core loop, studio API, and Web/PWA product client are out of scope until the private branching loop and retention economics are proven.
